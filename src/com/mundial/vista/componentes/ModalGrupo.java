...
public class ModalGrupo extends JDialog {
    ...
    public ModalGrupo(Window owner, String titulo, Grupo grupoAEditar) {
        super(owner, titulo, ModalityType.APPLICATION_MODAL);
        this.grupo = grupoAEditar;
        ...
        JLabel lblNombre = new JLabel("Nombre del Grupo (Ej. A, B, C)");
        lblNombre.setForeground(new Color(180, 190, 210));
        lblNombre.setFont(new Font("Segoe UI", Font.PLAIN, 14));
        txtNombre = crearTextField();
        
        if (grupoAEditar != null) {
            txtNombre.setText(grupoAEditar.getNombreGrupo());
        }
    ...
    private void validarYGuardar() {
        ...
        if (grupo == null) {
            grupo = new Grupo(0, txtNombre.getText().trim());
        } else {
            grupo.setNombreGrupo(txtNombre.getText().trim());
        }
